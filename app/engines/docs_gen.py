...
def build_commands_md(
    ...
    lines = [
        ...
        "```",
        "Field names are exact: `Name` (not `Action Name`/`title`), `Action Status`",
        "(Next/Waiting/Someday/Done — not `Status`/`To Do`), `Project` = array of ids,",
        "`date:Due:start` for the due date.",
        "",
