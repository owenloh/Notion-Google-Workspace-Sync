...
def build_commands_md(
    ...
    lines += [
        ...
        "",
        "## Data sources (parent ids for new rows)",
        "- Areas → `collection://54816fca-6f6c-4588-8c1a-1cdfcc6c9092`",
        "- Projects → `collection://f0ea8841-ca74-47b7-a28a-0b367bca8c41`",
        "- Actions → `collection://1d3eb1dd-2803-4692-a4d5-6ca9709ae570`",
        "",
        ...
        '  "body": {',
        '    "parent": { "data_source_id": "collection://1d3eb1dd-2803-4692-a4d5-6ca9709ae570" },',
        '    "pages": [ { "properties": {',
        '        "Name": "Email Bob",',
        '        "Action Status": "Next",',
